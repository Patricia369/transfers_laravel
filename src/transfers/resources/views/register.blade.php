...
<head>
  <meta charset="UTF-8">
  <title>ISLA TRANSFERS funcionando</title>
...
<body class="min-h-screen bg-gradient-to-r from-gray-800 via-gray-900 to-black flex items-center justify-center p-4">
  ...
  <form
    action="/Transfers/app/appController.php?controller=viajero&action=crearViajero"
    id="formRegister"
    method="POST"
    class="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-xl space-y-6">
